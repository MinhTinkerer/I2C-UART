...
//sree#define DA850_GPS_WAKEUP_PIN		//GPIO_TO_PIN(5, 0)
...
//	gpio_set_value(DA850_GPS_A_PIN, 1); //modified for GSM other pin mux side
//	gpio_set_value(DA850_GPS_B_PIN, 1);
...
static const short da850_evm_my_gpio_pins[] = { 
    DA850_GPIO5_9, DA850_GPIO5_10, DA850_GPIO8_9,                             
    -1                                         
};
...
/****Buzzzzzzzzz */
	...
	ret = da8xx_pinmux_setup(da850_evm_my_gpio_pins);                     
	if (ret)                                                                
