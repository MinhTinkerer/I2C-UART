...
static int __init sc16is7x2_init(void)
{
	...
	gpio_request(cs_pin_id,"chip-select-pin");
	gpio_direction_output(cs_pin_id,1);
	gpio_set_value(cs_pin_id,1);
	...
	gpio_request(irq_pin_id,"chip-select-pin");
	gpio_direction_input(irq_pin_id);
